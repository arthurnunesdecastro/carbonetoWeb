      ...
      <section className="relative overflow-hidden border-b border-white/5 pt-40">
        ...
        <div className="max-w-5xl mx-auto px-6 py-24 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <p className="text-[#0057FF] text-sm font-bold tracking-[0.2em] uppercase mb-6">{t.privacy.label}</p>
            <h1 className="text-6xl md:text-8xl font-display font-bold leading-[0.9] tracking-tight mb-8">
              {t.privacy.headline}<br />
              <span className="text-white/20">{t.privacy.headlineFade}</span>
            </h1>
            <p className="text-white/50 text-lg max-w-xl leading-relaxed">{t.privacy.intro}</p>
          </motion.div>
        </div>
      </section>
