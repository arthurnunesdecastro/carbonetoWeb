...
export const Hero = () => {
  ...
  return (
    <section className="relative w-full bg-carbon-blue text-white overflow-hidden pt-38 md:pt-60 pb-0">
      ...
      {/* Background Logo */}
      <div className="absolute top-10/25 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] md:w-[1200px] md:h-[1200px] opacity-10 md:opacity-20 pointer-events-none z-0">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col items-center text-center">
        ...
        >
          ...
          <a href="#" className="bg-carbon-black text-white px-4 py-2.5 rounded-full flex items-center gap-2.5 hover:bg-gray-900 transition-transform hover:scale-105 active:scale-95 shadow-xl">
            <img src="/assets/apple.webp" alt="Apple" className="h-7 w-auto" />
          ...
          {/* Google Play */}
          <a href="#" className="bg-carbon-black text-white px-4 py-2.5 rounded-full flex items-center gap-2.5 hover:bg-gray-900 transition-transform hover:scale-105 active:scale-95 shadow-xl">
            <img src="/assets/play.webp" alt="Google Play" className="h-7 w-auto" />
            <div className="text-left">
        ...
        <div className="relative w-full max-w-5xl h-[260px] md:h-[600px] flex justify-center items-start overflow-visible">
          ...
          >
            <img src="assets/perfil.webp" alt="My Program" className="h-[220px] md:h-[600px] w-auto" />
          </motion.div>
          ...
          >
            <img src="assets/categories.webp" alt="Performance" className="h-[220px] md:h-[600px] w-auto" />
          </motion.div>
